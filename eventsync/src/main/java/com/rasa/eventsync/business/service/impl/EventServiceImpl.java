...
public class EventServiceImpl implements EventService {
    ...
    public EventServiceImpl(EventRepository eventRepository,
                            FeedbackRepository feedbackRepository, EventMapStructMapper eventMapper, FeedbackMapStructMapper feedbackMapper, SentimentService sentimentService) {
    ...
    public FeedbackSummary getFeedbackSummary(Long eventId) {
        ...
        Map<String, Integer> sentimentCounts = feedbackList.stream()
            .collect(Collectors.groupingBy(Feedback::getSentiment, Collectors.summingInt(f -> 1)));
